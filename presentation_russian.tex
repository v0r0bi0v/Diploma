...
%            \end{proposition}
        ...
        \begin{frame}{$\mathrm{char}(\Delta) = 4$}
            \begin{itemize}
                ...
                \item Таким образом, результаты Бена-Эзры\textemdash Зельманова о структуре модулей $R, S, T, J$ останутся аналогичными, но слагаемых в структурных теоремах окажется вдвое больше.
            \end{itemize}
