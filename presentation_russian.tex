...
% Your name
    ...
    \begin{document}
        ...
        \begin{frame}{Подход Бена-Эзры\textemdash Зельманова}
            ...
            аналогичный гомоморфизм в общие матрицы над $\mathbb{Z}/2\mathbb{Z}$ (вместо $\mathbb{Z}_2$).
            ...
            \end{lemma}
            Однако, доказательство следующей теоремы оказывается весьма нетривиальным:
            \begin{theorem}
