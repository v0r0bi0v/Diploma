...
% Your name
    \institute[HSE] % Your institution as it will appear on the bottom of every slide, may be shorthand to save space
    {
        ...
        \centering\Large{Ivan Evgenevich Vorobiov} \\
        \centering\small{Scientific advisor Doctor of Sciences, professor\\ Alexei Yakovlevich Kanel-Belov\\}
        \centering\small{Scientific co-advisor Candidate of Sciences\\ Anton Sergeevich Khoroshkin}
    }
