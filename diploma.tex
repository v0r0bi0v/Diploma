...
%%
    ...
    Дополнительно, мы заметим, что именно результат, которого касалась последняя курсовая работа автора (частный случай методов Гришина\ \cite{Grishin}, описанный элементарными методами) помогает в доказательстве гипотезы Гельфанда.
...
%    todo тут хотелось бы аккуратно все эти вещи доказать, почему это про-$p$ кольцо и почему сейчас получится даже про-$p$ группа.
    ...
    \section{Подход Бена-Эзры--Зельманова, $p = 2, \char(\Delta) = 2$}
    ...
    \section{Конечная базируемость $T$-пространств в кольце многочленов над полем характеристики $0$}


    \section{Связь методов Гришина ~\cite{Grishin} с гипотизей Гельфанда}
