...
В завершение отметим, что методы Гришина приведенные в доказательстве теоремы~\ref{main} показывают, что конечная базируемость может быть доказана лишь относительно ключевых подстановок и линейных комбинаций.