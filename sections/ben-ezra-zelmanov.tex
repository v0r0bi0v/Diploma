...
\end{align*}
Кольцо $R$ называется кольцом псевдо-общих матриц.\\
Далее авторы исследуют некоторые свойства этих колец.
...
Построим гомоморфизм из нее в $R$, определенный $X\mapsto \tilde{X}, Y\mapsto\tilde{Y}$, который индуцирует градуировку на $R$:
\vskip 0.1in\noindent
\begin{proposition}
...
И пусть $\hat{J}$ ~--- замыкание $J$ в топологии градуировки $R$.\\
...
\begin{proposition}
    ...
    \begin{enumerate}
        ...
        \item свободным $T$-модулем порожденным \[[\tilde{X}, \tilde{Y}] \tilde{X}, \quad [\tilde{X}, \tilde{Y}] \tilde{Y}, \quad [\tilde{X}, \tilde{Y}]^2, \quad [\tilde{X}, \tilde{Y}]\tilde{X}\tilde{Y}\]
    \end{enumerate}
\end{proposition}
\vskip 0.1in\noindent
