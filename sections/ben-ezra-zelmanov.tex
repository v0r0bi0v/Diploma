...
\begin{align*}
    & S = \quad \langle \trace(\tilde{X}),\quad \trace(\tilde{Y}),\quad [\tilde{X},\quad \tilde{Y}]^2 \rangle \subseteq \tilde{S} \\
    & T = \quad \langle \trace(\tilde{X}),\quad  \trace(\tilde{Y}),\quad  \trace(\tilde{X}\tilde{Y}) \rangle \subseteq \tilde{S} \\
