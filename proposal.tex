...
%%
    ...
    We are going to prove a slightly different version of the theorem 3.2.1 for the case $\mathrm{char}(\Delta)=4$ and perhaps we will be able to do the similar thing for $\mathrm{char}(\Delta)=2^l$.
